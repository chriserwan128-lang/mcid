      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {services.map((service, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-mcid-gold/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity durée-700 pointer-events-none" />
              ...
              <div className="flex items-center gap-3 text-mcid-gold-light font-bold text-sm tracking-widest uppercase group-hover:gap-6 transition-all durée-300 opacity-0 group-hover:opacity-100 absolute bottom-10 left-12 z-10">
